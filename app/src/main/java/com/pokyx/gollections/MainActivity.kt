...
import com.pokyx.gollections.ui.navigation.ProfileRoute
                        ...
                        NavHost(
                            ...
                            composable<CollectionDetailRoute> { backStackEntry ->
                                ...
                                CollectionDetailScreen(
                                    animatedVisibilityScope = this@composable,           // <-- À AJOUTER
                            ...
                            composable<ItemDetailRoute> { backStackEntry ->
                                ...
                                ItemDetailScreen(
                                    animatedVisibilityScope = this@composable, // <-- L'outil d'animation
                                    sharedTransitionScope = this@SharedTransitionLayout, // <-- L'outil d'animation
                                    itemId = route.itemId,
                                    onBackClick = { navController.popBackStack() },
                                    onEditClick = { id ->
